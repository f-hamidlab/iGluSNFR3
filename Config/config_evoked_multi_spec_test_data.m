function ops_multi = config_evoked_multi_spec_test_data(ops)
    ...
    i = 3; % for the 3th image, same stimulation was delayed for 50 frames
    ops_multi{i}.first_stim      =  3.5;                   % Time of first stimulus [s]
