...
ops.filedir = '../../originals/Example data for demo/'; % folder
ops.fileformat = '.tif';

% path to saving directory
ops.savedir = '../../outputs/Example data for demo/'; % folder
...
ops.tophat_max_dff_r = 12; % radius for tophat filter % 12 [px]
ops.use_binary_mask = false; % use binary mask from ImageJ
ops.remove_px_with_no_spikes = true; % after masking, remove pixels with no activity. Set to false for recordings of low SNR.
ops.redo_detection = true; % if data is already processed, redo event detection or not
...
ops.experiment_type = "spontaneous"; % "evoked" or "spontaneous"
...
ops.ST.option           = "MLspike"; % "findpeaks" or "MLspike"
